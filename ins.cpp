...
{ "op19",       CF_CHG1 | CF_USE2             }, //op19             ($addr1),$data                           
{ "op1B",       CF_CHG1 | CF_USE2             }, //op1B            ($addr1), ($addr1)                        
{ "op21",       CF_USE1 | CF_USE2             }, //op21            ($addr1),$data                            
{ "op29",       CF_CHG1 | CF_USE2             }, //op29             ($addr1),$data                           
{ "op39",       CF_CHG1 | CF_USE2             }, //op39             ($addr1),$data                           
...
{ "op98",       CF_CHG1 | CF_USE2             }, //op98            ($addr1), $imm                            
...
{ "bge",        CF_USE1                       }, //bge $addr                                                 
{ "ble",        CF_USE1                       }, //ble $addr                                                 
{ "call",       CF_USE1 | CF_CALL             }, //call $addr                                                
{ "call2",      CF_USE1 | CF_CALL             }, //call2 $addr                                               
{ "ret",        CF_STOP                       }, //ret
{ "opF8",       CF_USE1 | CF_USE2             }, //opF8            $imm, $imm                                
